  ...
  return (
    <Card
      ...
      sx={(theme) => {
        ...
        const cardShadow = shadow || customShadows.z1 || theme.shadows[1];

        return {
          position: 'relative',
          ...(border && { border: `1px solid ${palette.grey?.A800 || palette.divider || theme.palette.divider}` }),
          borderRadius: 1,
          boxShadow: boxShadow && !border ? cardShadow : 'inherit',
          ':hover': { boxShadow: boxShadow ? cardShadow : 'inherit' },
          ...(codeHighlight && {
